...
export function frustum(left, right, bot, top, near, far) {
  return [
...
export function createProgFromShaders(gl, vertex, fragment) {
...
export function createProgFromShaderSources(gl, vertex, fragment) {
