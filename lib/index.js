...
export function setup(
  ...
  assert(selectedColorCh !== undefined);
  ...
  primSelect.addEventListener("change", (evt) => {
    ...
    indices = createIndices(
      imgData.width, imgData.height, selectedPrim, extOesElementIndexUint
    );
...
function createIndices(w, h, prim, extOesElementIndexUint) {
